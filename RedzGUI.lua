	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(7, 7, 7)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(7, 7, 7)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(7, 7, 7))
			}),
...
local UIScale = ViewportSize.Y / 580
